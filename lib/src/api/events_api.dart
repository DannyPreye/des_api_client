...
class EventsApi {
  ...
  /// Parameters:
  /// * [eventCreate] 
  /// * [checkConflicts] - Whether to check for scheduling conflicts
  ...
  Future<Response<BuiltList<EventDTO>>> bulkCreateEventsEventsBulkPost({ 
    required BuiltList<EventCreate> eventCreate,
    ...
    final _queryParameters = <String, dynamic>{
      if (checkConflicts != null) r'check_conflicts': encodeQueryParameter(_serializers, checkConflicts, const FullType(bool)),
    };

    dynamic _bodyData;

    try {
      const _type = FullType(BuiltList, [FullType(EventCreate)]);
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ConflictCheckResponse>> checkConflictsEventsCheckConflictsPost({ 
    required BodyCheckConflictsEventsCheckConflictsPost bodyCheckConflictsEventsCheckConflictsPost,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/events/check-conflicts';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(BodyCheckConflictsEventsCheckConflictsPost);
      _bodyData = _serializers.serialize(bodyCheckConflictsEventsCheckConflictsPost, specifiedType: _type);
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<EventDTO>> createEventEventsPost({ 
  ...
  /// Returns a [Future] containing a [Response] with a [EventDTO] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<EventDTO>> deleteEventEventsEventIdDelete({ 
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [EventAnalytics] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<EventAnalytics>> getAnalyticsEventsAnalyticsSummaryGet({ 
    DateTime? startDate,
    DateTime? endDate,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    ...
    final _path = r'/events/analytics/summary';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    EventAnalytics? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(EventAnalytics),
      ) as EventAnalytics;
    ...
    return Response<EventAnalytics>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Parameters:
  /// * [eventId] 
  /// * [incrementViews] - Whether to increment the view count
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// Returns a [Future] containing a [Response] with a [EventDTO] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<EventDTO>> getEventEventsEventIdGet({ 
    required int eventId,
    bool? incrementViews = true,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _queryParameters = <String, dynamic>{
      if (incrementViews != null) r'increment_views': encodeQueryParameter(_serializers, incrementViews, const FullType(bool)),
    };
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [EventListResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<EventListResponse>> listEventsEventsGet({ 
    int? skip = 0,
    int? limit = 100,
    EventStatus? status,
    String? eventType,
    ...
    final _queryParameters = <String, dynamic>{
      ...
      r'status': encodeQueryParameter(_serializers, status, const FullType(EventStatus)),
      r'event_type': encodeQueryParameter(_serializers, eventType, const FullType(String)),
      r'start_date': encodeQueryParameter(_serializers, startDate, const FullType(DateTime)),
      r'end_date': encodeQueryParameter(_serializers, endDate, const FullType(DateTime)),
      r'academic_year_id': encodeQueryParameter(_serializers, academicYearId, const FullType(int)),
    ...
    EventListResponse? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(EventListResponse),
  ...
  /// Returns a [Future] containing a [Response] with a [EventDTO] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<EventDTO>> updateEventEventsEventIdPut({ 
    required int eventId,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BuiltMap<String, JsonObject>>> updateEventsStatusEventsStatusPut({ 
    required BodyUpdateEventsStatusEventsStatusPut bodyUpdateEventsStatusEventsStatusPut,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(BodyUpdateEventsStatusEventsStatusPut);
      _bodyData = _serializers.serialize(bodyUpdateEventsStatusEventsStatusPut, specifiedType: _type);

...
class TenantManagementApi {
  ...
  Future<Response<JsonObject>> onboardTenantTenantsOnboardPost({ 
    required TenantCreate tenantCreate,
    ...
    try {
      const _type = FullType(TenantCreate);
      _bodyData = _serializers.serialize(tenantCreate, specifiedType: _type);

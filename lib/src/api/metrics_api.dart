...
class MetricsApi {
  ...
  Future<Response<BuiltMap<String, JsonObject>>> getMetricsMetricsGet({ 
    String? module,
    ...
    final _queryParameters = <String, dynamic>{
      r'module': encodeQueryParameter(_serializers, module, const FullType(String)),
    };
  ...
  /// Returns a [Future] containing a [Response] with a [BuiltMap<String, JsonObject>] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BuiltMap<String, JsonObject>>> getModuleMetricsMetricsModuleModuleNameGet({ 
    ...
    final _path = r'/metrics/module/{module_name}'.replaceAll('{' r'module_name' '}', encodeQueryParameter(_serializers, moduleName, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<JsonObject>> getPrometheusMetricsMetricsPrometheusGet({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/metrics/prometheus';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,

...
class AssessmentsApi {
  ...
  Future<Response<BuiltList<AssessmentConfigDTO>>>
    ...
    final _path = r'/assessments/configs';
    ...
    BuiltList<AssessmentConfigDTO>? _responseData;
    ...
    return Response<BuiltList<AssessmentConfigDTO>>(
      data: _responseData,
  ...
  Future<Response<CreateResponse>> createAssessmentScoreAssessmentsScoresPost({
    ...
    final _path = r'/assessments/scores';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<AssessmentTypeDTO>> createAssessmentTypeAssessmentsTypesPost({
    ...
    final _path = r'/assessments/types';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    AssessmentTypeDTO? _responseData;
    ...
    return Response<AssessmentTypeDTO>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<BuiltList<AssessmentScoreDTO>>>
    ...
    final _path = r'/assessments/scores/bulk';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    BuiltList<AssessmentScoreDTO>? _responseData;
    ...
    return Response<BuiltList<AssessmentScoreDTO>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<ClassAssessmentsScoresResponse>>
    ...
    final _path = r'/assessments/section/scores';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    ClassAssessmentsScoresResponse? _responseData;
    ...
    return Response<ClassAssessmentsScoresResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  ///
  /// Parameters:
  /// * [classEnrollmentId] - Class enrollment id
  ...
  Future<Response<BuiltList<StudentSubjectAssessmentScore>>>
    ...
    final _path = r'/assessments/students/scores';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    BuiltList<StudentSubjectAssessmentScore>? _responseData;
    ...
    return Response<BuiltList<StudentSubjectAssessmentScore>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<SubjectScoresByAssessmentResponse>>
    ...
    final _path = r'/assessments/subjects/scores';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    SubjectScoresByAssessmentResponse? _responseData;
    ...
    return Response<SubjectScoresByAssessmentResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Parameters:
  /// * [termId] - Filter by term
  /// * [classSubjectId] - Filter by class subject
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  ///
  /// Parameters:
  /// * [activeOnly] - Filter active types only
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  Future<Response<BuiltList<AssessmentTypeDTO>>>
    ...
    BuiltList<AssessmentTypeDTO>? _responseData;
    ...
    return Response<BuiltList<AssessmentTypeDTO>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<BuiltList<AssessmentScoreDTO>>>
    ...
    final _path = r'/assessments/assessments';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<AssessmentConfigDTO>>
    ...
    AssessmentConfigDTO? _responseData;
    ...
    return Response<AssessmentConfigDTO>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,

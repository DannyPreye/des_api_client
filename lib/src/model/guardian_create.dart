...
/// * [subId] 
@BuiltValue()
abstract class GuardianCreate implements Built<GuardianCreate, GuardianCreateBuilder> {
  ...
  factory GuardianCreate([void updates(GuardianCreateBuilder b)]) = _$GuardianCreate;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(GuardianCreateBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<GuardianCreate> get serializer => _$GuardianCreateSerializer();
}

class _$GuardianCreateSerializer implements PrimitiveSerializer<GuardianCreate> {
  @override
  final Iterable<Type> types = const [GuardianCreate, _$GuardianCreate];

  @override
  final String wireName = r'GuardianCreate';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    GuardianCreate object, {
  ...
  void _deserializeProperties(
    ...
    required GuardianCreateBuilder result,
  ...
  @override
  GuardianCreate deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = GuardianCreateBuilder();

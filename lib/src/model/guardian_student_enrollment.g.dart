...
part of 'guardian_student_enrollment.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$GuardianStudentEnrollment extends GuardianStudentEnrollment {
  @override
  final String fname;
  @override
  final String sname;
  ...
  factory _$GuardianStudentEnrollment(
          [void Function(GuardianStudentEnrollmentBuilder)? updates]) =>
      (GuardianStudentEnrollmentBuilder()..update(updates))._build();

  _$GuardianStudentEnrollment._(
      {required this.fname,
      required this.sname,
      this.mname,
      this.gtitle,
      ...
      : super._();
  @override
  GuardianStudentEnrollment rebuild(
          void Function(GuardianStudentEnrollmentBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  GuardianStudentEnrollmentBuilder toBuilder() =>
      GuardianStudentEnrollmentBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is GuardianStudentEnrollment &&
        fname == other.fname &&
        sname == other.sname &&
        mname == other.mname &&
        gtitle == other.gtitle &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'GuardianStudentEnrollment')
          ..add('fname', fname)
          ..add('sname', sname)
          ..add('mname', mname)
          ..add('gtitle', gtitle)
...
class GuardianStudentEnrollmentBuilder
    implements
        Builder<GuardianStudentEnrollment, GuardianStudentEnrollmentBuilder> {
  _$GuardianStudentEnrollment? _$v;
  ...
  GuardianStudentEnrollmentBuilder() {
    GuardianStudentEnrollment._defaults(this);
  }

  GuardianStudentEnrollmentBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
      _fname = $v.fname;
      _sname = $v.sname;
  ...
  @override
  void replace(GuardianStudentEnrollment other) {
    _$v = other as _$GuardianStudentEnrollment;
  }

  @override
  void update(void Function(GuardianStudentEnrollmentBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  GuardianStudentEnrollment build() => _build();

  _$GuardianStudentEnrollment _build() {
    _$GuardianStudentEnrollment _$result;
    try {
      _$result = _$v ??
          _$GuardianStudentEnrollment._(
            fname: BuiltValueNullFieldError.checkNotNull(
                fname, r'GuardianStudentEnrollment', 'fname'),
            sname: BuiltValueNullFieldError.checkNotNull(
                sname, r'GuardianStudentEnrollment', 'sname'),
            mname: mname,
            gtitle: gtitle,
            photo: photo,
            username: username,
            ...
            phone: BuiltValueNullFieldError.checkNotNull(
                phone, r'GuardianStudentEnrollment', 'phone'),
            ...
            relationship: BuiltValueNullFieldError.checkNotNull(
                relationship, r'GuardianStudentEnrollment', 'relationship'),
            isPrimary: isPrimary,
          );
    } catch (_) {
      ...
      try {
        ...
        throw BuiltValueNestedFieldError(
            r'GuardianStudentEnrollment', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
